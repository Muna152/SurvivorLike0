...
- **说明**: 飞刀大幅削弱(8→5基础伤害, 8→7弹数Lv8); 旋转盾增强(5→8基础伤害); 圣水大幅增强(3→5基础伤害, 6→5s冷却); 圣光增强(持续5→9s); 被动道具对齐GDD: Wing 0.8→0.24(+8%/级), Feather 1→0.5(+1弹/2级), Heart +10→+12, Magnet 1.0→1.25
...
- **说明**: 敌人HP小幅上调(骷髅10→12, 蝙蝠5→6等); 敌人伤害下调(法师12→10, 僵尸8→6); Boss HP大幅提升(骷髅王500→800, 暗夜领主2000→3000, 死神5000→8000); Boss伤害大幅提升(2→8, 3→12, 5→15); DifficultyManager缩放降低(HP +10→8%/min, 伤害 +5→3%/min); 掉落率提升(烤鸡0.1→2%, 宝箱0.5→1.5%)
...
- **说明**: XP公式 5+3×Lv² → 5+2×Lv²; 敌人EXP上调(骷髅/蝙蝠1→2); 30min累计XP约19,000 → 可达Lv28-32
...
- **说明**: 6把进化武器全部重做数值，Lv1 DPS≈原Lv8×1.5-1.8，Lv8 DPS≈原Lv8×2.5-3.0; 圣剑90dmg/0.5s×4proj; 无限飞刀28dmg/0.06s×10proj; 审判之轮68dmg/0.08s×7轨道; 虚空黑洞45dmg/0.15s×3区域; 天使之歌38dmg/0.25s×3区域; 亡灵洪流38dmg/0.1s×3区域
- **验收**: 进化武器显著强于8级原版；但不破坏游戏节奏

#### T4.4.5 调整永久升级费用
- **状态**: ✅
- **依赖**: T4.1.3
- **产物**: 更新 GoldManager.cs 费用表
- **说明**: 伤害加成费用减半(100/200/400/800/1600→50/100/200/400/800); 拾取范围降低(30/60/120/240/480→20/40/80/160/320); 额外生命降低(500/1000/2000→300/600/1200)
- **验收**: 费用递增合理；单局金币收入约500-1500
